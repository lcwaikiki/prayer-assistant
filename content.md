...
| Localization | `flutter gen-l10n`, 14 locales (unified AppLocalizations & Tesbihat adapter) |
...
- Beads module translations unified into `AppLocalizations` via standard `gen-l10n`.
